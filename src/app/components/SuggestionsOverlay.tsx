...
export default function SuggestionsOverlay({ suggestionsRef, onPointerDown, setShowSuggestions }: Props) {
      ...
      <div className={`relative h-full w-full ${isClosing ? 'dockDown' : 'dockUp'}`}>
        ...
        <div className="border-[4px] sm:border-[6px] border-[#36312C] rounded-xl h-full flex flex-col relative z-10 overflow-hidden bg-[#12162A]">
          ...
          <div
            ...
            className="touch-none shrink-0 flex items-center justify-center bg-[#1B2140] border-b-[3px] sm:border-b-[4px] border-[#36312C]
