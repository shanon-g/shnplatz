...
// --- UPDATED: Added arcade_screen and tv_screen ---
...
// --- UPDATED: Added images for the gallery popup ---

// Make sure these files exist in public/journey/ !
...
export default function JourneyOverlay({ journeyRef, onMouseDown, setShowJourney }: Props) {
  ...
  useEffect(() => {
      ...
      (gltf: GLTFResult) => {
        ...
        if (hoverRoot) {
          ...
          gltf.scene.traverse((o: any) => {
            ...
            // --- UPDATED: Allow pic_*, arcade_screen, and tv_screen ---

            if (o.isMesh && (

                o.name?.startsWith('pic_') ||

                o.name === 'arcade_screen' ||
    ...
    const pickInteractable = (obj: any) => {

      let o = obj;

      while (o) {

        // --- UPDATED: Picker logic to include screens ---
    ...
    const onPointerMove = (e: PointerEvent) => {
      ...
      for (const h of hits) {
        ...
        const cand = pickInteractable(h.object);
